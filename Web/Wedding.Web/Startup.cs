namespace Wedding.Web
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBackgroundImageService, BackgroundImageService>();
            services.AddTransient<IPostsService, PostsService>();
            services.AddTransient<IOrganizedTransportService, OrganizedTransportService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(
                endpoints =>
                    {
                        // endpoints.MapControllerRoute("forumCategory", "f/{id:minlength(3)}", new { controller = "Home", action = "Index" });
